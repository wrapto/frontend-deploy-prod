...
1. On Wrapto (**[https://wrapto.app](https://wrapto.app)**), choose **“Transfer From”** as PAC (source token) and select the target chain (e.g., Ethereum).
...
3. Make sure your wallet is on the correct chain (Base, BNB Chain, Etheruem or Polygon — whichever holds your WPAC).
